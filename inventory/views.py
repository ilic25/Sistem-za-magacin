...
class StockCreateView(SuccessMessageMixin, CreateView):                                 # createview class to add new stock, mixin used to display message
    ...
    success_message = "Zaliha je uspešno kreirana."                             # displays message when form is submitted

    def get_context_data(self, **kwargs):                                               # used to send additional context
        context = super().get_context_data(**kwargs)
        context["title"] = 'Nove zalihe'
        context["savebtn"] = 'Dodaj u magacin'
        return context       
...
class StockUpdateView(SuccessMessageMixin, UpdateView):                                 # updateview class to edit stock, mixin used to display message
    ...
    template_name = "edit_stock.html"                                                   # 'edit_stock.html' used as the template
    success_url = '/inventory'                                                          # redirects to 'inventory' page in the url after submitting the form
    success_message = "Zaliha je uspešno ažurirana."                             # displays message when form is submitted

    def get_context_data(self, **kwargs):                                               # used to send additional context
        context = super().get_context_data(**kwargs)
        context["title"] = 'Uredi zalihe'
        context["savebtn"] = 'Azuriraj zalihe'
        context["delbtn"] = 'Obrisi zalihe'
        return context
...
class StockDeleteView(View):                                                            # view class to delete stock
    ...
    success_message = "Zaliha je uspešno obrisana."                             # displays message when form is submitted
