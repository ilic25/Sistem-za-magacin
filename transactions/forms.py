...
class SelectSupplierForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['supplier']
        labels = {
            'supplier': 'Dobavljač:',  # Change the label here
        }
...
class SupplierForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['pib'].widget.attrs.update({'class': 'textinput form-control'})  # Add styling for PIB

    class Meta:
        model = Supplier
        fields = ['name', 'phone', 'address', 'email', 'gstin', 'pib']
        widgets = {
...
class SaleForm(forms.ModelForm):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['email'].widget.attrs.update({'class': 'textinput form-control'})
        self.fields['gstin'].widget.attrs.update({'class': 'textinput form-control'})
        self.fields['mb'].widget.attrs.update({'class': 'textinput form-control'})
    
    class Meta:
        model = SaleBill
        fields = ['name', 'phone', 'address', 'email', 'gstin','mb']
        widgets = {
            'address': forms.Textarea(
                attrs={
                    'class': 'textinput form-control',
