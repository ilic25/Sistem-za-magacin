...
class SupplierCreateView(SuccessMessageMixin, CreateView):
    ...
    success_message = "Dobavljač je uspešno kreiran."
    template_name = "suppliers/edit_supplier.html"
    
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = 'Novi Dobalvljac'
        context["savebtn"] = 'Dodaj dobavljaca'
        return context     
...
class SupplierUpdateView(SuccessMessageMixin, UpdateView):
    ...
    form_class = SupplierForm
    success_url = '/transactions/suppliers'
    success_message = "Detalji dobavljača su uspešno ažurirani."
    template_name = "suppliers/edit_supplier.html"
    
    def get_context_data(self, **kwargs):
        context = super().get_context_data(**kwargs)
        context["title"] = 'Uredi dobavljaca'
        context["savebtn"] = 'Sacuvaj promene'
        context["delbtn"] = 'Obrisi dobavljaca'
        return context

# used to delete a supplier
class SupplierDeleteView(View):
    template_name = "suppliers/delete_supplier.html"
    success_message = "Dobavljač je uspešno obrisan."
    ...
    def post(self, request, pk):  
        supplier = get_object_or_404(Supplier, pk=pk)
        # Umesto da postavljate `is_deleted` na `True`, direktno brišete dobavljača
        supplier.delete()
...
class PurchaseCreateView(View):                                                 
    ...
    def post(self, request, pk):
        ...
        if formset.is_valid():
            try:
                # saves bill
                billobj = PurchaseBill()  # Create a new PurchaseBill object
                billobj.supplier = supplierobj  # Associate with the supplier
                billobj.save()
                ...
                billdetailsobj.save()
                messages.success(request, "Kupljeni artikli su uspešno registrovani.")
    ...
    def delete(self, *args, **kwargs):
        ...
        for item in items:
            ...
            if stock.is_deleted == False:
                ...
                stock.save()
        messages.success(self.request, "Račun za kupovinu je uspešno obrisan.")
...
class SaleCreateView(View):                                                      
    ...
    def post(self, request):
        ...
        if form.is_valid() and formset.is_valid():
            ...
            billdetailsobj.save()
            messages.success(request, "Prodata roba je uspešno registrovana.")
    ...
    def delete(self, *args, **kwargs):
        ...
        for item in items:
            ...
            if stock.is_deleted == False:
                stock.quantity += item.quantity
                stock.save()
        messages.success(self.request, "Račun za prodaju je uspešno obrisan.")
...
class PurchaseBillView(View):
    ...
    def post(self, request, billno):
        ...
        if form.is_valid():
            ...
            billdetailsobj.save()
            messages.success(request, "Detalji računa su uspešno izmenjeni.")
        else:
            messages.error(request, "Došlo je do greške u unosu podataka.")
